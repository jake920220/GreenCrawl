...
var modelTonName = __data.modelTonName;
                ...
                async.waterfall([
                    ...
                    //DB에서 하나하나 비교해서 있는지 없는지 확인한다
                        ...
                        async.each(resultArr, function (obj, cb) {
                            green.findOne({
                                ...
                                if (data != null) {
                                    needToRemoveDB.push(data.key);
                                    needToRemoveCSV.push(obj.key);
                                    index++;
                                    cb();
                                } else {
                                    index++;
                    ...
                    function (next) {
                        ...
                        for(var i=0; i<resultArr.length; i++){
                            if(needToRemoveCSV.indexOf(resultArr[i].key) != -1){
